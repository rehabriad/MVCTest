...
{
    public static MvcTest.Controllers.BaseController Base = new MvcTest.Controllers.T4MVC_BaseController();
    public static MvcTest.Controllers.HomeController Home = new MvcTest.Controllers.T4MVC_HomeController();
...
[GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
public class T4MVC_System_Web_Mvc_JsonNetResult : System.Web.Mvc.JsonNetResult, IT4MVCActionResult
{
    public T4MVC_System_Web_Mvc_JsonNetResult(string area, string controller, string action, string protocol = null): base(default(object))
    {
...
[GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
public class T4MVC_System_Web_Mvc_XmlResult : System.Web.Mvc.XmlResult, IT4MVCActionResult
{
    public T4MVC_System_Web_Mvc_XmlResult(string area, string controller, string action, string protocol = null): base(default(object))
    {
        this.InitMVCT4Result(area, controller, action, protocol);
    }
